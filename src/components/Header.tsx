...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 h-16 glass border-b border-[var(--color-border)] relative">
      <div className="h-full max-w-[1920px] mx-auto px-4 flex items-center justify-between gap-4">
        ...
        >
          <div
            className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-500 to-cyan-500 
        ...
        >
          ...
          <input
            ...
            placeholder={
              language === "fr"
                ? "Pays, couleur, élément..."
                : "Country, color, element..."
            }

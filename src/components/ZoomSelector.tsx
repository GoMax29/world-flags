...
export function ZoomSelector() {
  ...
  return (
    <div className="flex items-center justify-center gap-1 p-1.5 bg-[var(--color-surface)] rounded-lg border border-[var(--color-border)]">
      {zoomOptions.map((option) => (
        <motion.button
          ...
          className={cn(
            "relative px-3 py-2 rounded-md flex items-center gap-2 transition-colors",
